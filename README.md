...
Repository Structure
.
├── House_prices.ipynb        # Full cleaning, encoding, and modeling notebook
...
├── requirements.txt          # Pinned dependencies (pandas 3.0, scikit-learn 1.8)
└── README.md
Setup & Installation
...
train.csv, test.csv, and data_description.txt are already included in this repository — no separate download needed.
